     ...
     <div
      ...
      <div className="flex flex-row justify-center items-start gap-4">
        ...
        <div  className="flex flex-col">
          <h2 className="text-xl font-bold text-[#E93F3F]">Add New</h2>
          <p className="text-sm text-muted-foreground max-w-[220px]">Create a new playground</p>
        </div>
      </div>
      <div className="relative overflow-hidden ">
        <Image src={"/add-new.svg"} width={150} height={150} alt="image" className="transition-transform duration-300 group-hover:scale-105"/>
